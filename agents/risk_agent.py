...
class RiskInversionAgent(BaseAgent):
    ...
    def build_messages(self, idea: str, context: dict[str, Any]) -> list[dict]:
        system = (
            ...
            "2. Macro economic exposure mapping\n"
            "3. Regulatory and compliance risk detection\n"
            "4. Operational fragility assessment\n"
            ...
            "- regulatory_risks: list of objects with 'risk', 'jurisdiction', 'severity', 'timeline'\n"
