...
class PricingAdvisorAgent(BaseAgent):
    ...
    def build_messages(self, idea: str, context: dict[str, Any]) -> list[dict]:
        system = (
            ...
            "- monetization_models: list of 2-3 recommended revenue models (e.g. freemium, usage-based)\n"
            "- pricing_tiers: list of suggested tiers (name, price range, features)\n"
            "- willingness_to_pay_assessment: evaluation of target market's budget and WTP\n"
            "- unit_economics: brief est. of LTV and CAC considerations\n"
            "- pricing_risks: list of challenges (e.g., race to bottom, perceived value)\n"
